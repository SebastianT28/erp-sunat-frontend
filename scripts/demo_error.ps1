...
# Simula fallos operacionales que necesitan atencion
# Uso: .\demo_error.ps1
# =============================================================
...
Write-Host "  Simula fallos operacionales que necesitan atencion" -ForegroundColor Red
Write-Host "=============================================================" -ForegroundColor Red
Write-Host ""

foreach ($area in $areas) {
    Write-Host "  [ERROR] Disparando evento en area: $area ..." -ForegroundColor Red -NoNewline
    try {
